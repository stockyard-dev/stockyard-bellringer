package server
import("encoding/json";"net/http";"github.com/stockyard-dev/stockyard-bellringer/internal/store")
...
func(s *Server)routes(){
    s.mux.HandleFunc("GET /health",func(w http.ResponseWriter,r *http.Request){writeJSON(w,200,map[string]string{"status":"ok","service":"stockyard-bellringer"})})
    ...
    s.mux.HandleFunc("GET /api/subscriptions",s.handleListSubs)
    s.mux.HandleFunc("POST /api/notify",s.handleSend)
