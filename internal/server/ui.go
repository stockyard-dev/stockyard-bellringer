...
<div class="hdr">
<h1 id="dash-title"><span>&#9670;</span> BELLRINGER</h1>
...
var fields=[{"name": "id", "label": "Id", "type": "text"}, {"name": "title", "label": "Title", "type": "text"}, {"name": "body", "label": "Body", "type": "textarea"}, {"name": "url", "label": "Url", "type": "text"}, {"name": "icon", "label": "Icon", "type": "text"}, {"name": "channel", "label": "Channel", "type": "text"}, {"name": "sent_count", "label": "Sent Count", "type": "integer"}, {"name": "click_count", "label": "Click Count", "type": "integer"}, {"name": "created_at", "label": "Created At", "type": "text"}];
